...
import EventImageMapping from "../const/EventImageMapping.js";
...
const Tickets = ({ tickets }) => {
    ...
    if (tickets.length > 0) {
        ...
        let ticketImgSrc = EventImageMapping[ticket.eventName];
            ...
            <div className="ticket-container">
                ...
                <div className="ticket">
                    ...
                    <div className="ticket-qr-code">
                        ...
                        {ticket.transferCount < ticket.maxTransferCount && !!ticket && currentPath === transferPath && 
                            <Link to="/" state={{ ticket: JSON.stringify(ticket), contractAddress: eventContractAddress }}>
                                <button className="ticket-return-to-home">Go back</button>
                            </Link>
                        }
                    </div>
                </div>
