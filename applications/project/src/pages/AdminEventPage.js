        ...
        <div className="container">
            ...
            <section className="events-section">
                ...
                <div className="events-container">
                    <AdminEventComponent eventStar="Panther Chan" eventTime="Apr 13 - 8:15PM" 
                    eventLocation="Star Hall, KITEC" eventImgPath="/imgs/panther-chan.png"/>
                    <AdminEventComponent eventStar="Kaho Hung" eventTime="Apr 13 - 8:15PM" 
                    eventLocation="Hong Kong Coliseum" eventImgPath="/imgs/kaho-hung.png" />
                    <AdminEventComponent eventStar="Creamfield HK" eventTime="Apr 14 - 5:00PM" 
                    eventLocation="Central Harbourfront Event Space" eventImgPath="/imgs/creamfield-hk.png" />
                    <AdminEventComponent eventStar="Midlife, Sing & Shine 2" eventTime="Jul 19 - 8:15PM" 
